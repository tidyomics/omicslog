...
RUN R -e "install.packages(c('devtools', 'BiocManager', 'ggplot2', 'dplyr', 'tidyr', 'shiny', 'lubridate', 'data.table', 'caret', 'randomForest', 'xgboost', 'plotly', 'readr'), repos='https://cloud.r-project.org')"
